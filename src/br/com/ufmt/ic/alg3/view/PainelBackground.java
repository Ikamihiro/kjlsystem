...
public class PainelBackground extends JPanel {
    ...
    //atributo que recebe o caminho da imagem
    ...
    public PainelBackground(String pathImage) {
		...
		*/
        ...
        try {
			...
			*/
            ...
            Logger.getLogger(PainelBackground.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
}